import { MathUtil, Matrix, Quaternion, Vector3 } from '../math';
...
export class LiteTransform {
  ...
  private _updateFlagManager: LiteUpdateFlagManager =
    new LiteUpdateFlagManager();
  ...
  set rotationQuaternion(value: Quaternion) {
    ...
    this._setDirtyFlagTrue(
      TransformFlag.LocalMatrix | TransformFlag.LocalEuler
    );
    this._setDirtyFlagFalse(TransformFlag.LocalQuat);
