...
import { BoundingSphere, Ray, Vector3 } from '../../math';
 ...
 */
export class LiteSphereColliderShape
  extends LiteColliderShape
  implements ISphereColliderShape
{
  ...
  _raycast(ray: Ray, hit: LiteHitResult): boolean {
    ...
    Vector3.transformCoordinate(
      ...
      this._collider._transform.worldMatrix,
