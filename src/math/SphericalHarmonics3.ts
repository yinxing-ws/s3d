...
export class SphericalHarmonics3 implements IClone {
  ...
  setValueByArray(array: ArrayLike<number>, offset: number = 0): void {
    ...
    (s[6] = array[6 + offset]),
      ...
      (s[8] = array[8 + offset]);
    (s[9] = array[9 + offset]),
      (s[10] = array[10 + offset]),
      (s[11] = array[11 + offset]);
    (s[12] = array[12 + offset]),
      (s[13] = array[13 + offset]),
      (s[14] = array[14 + offset]);
    (s[15] = array[15 + offset]),
      (s[16] = array[16 + offset]),
      (s[17] = array[17 + offset]);
    (s[18] = array[18 + offset]),
      (s[19] = array[19 + offset]),
      (s[20] = array[20 + offset]);
    (s[21] = array[21 + offset]),
      (s[22] = array[22 + offset]),
      (s[23] = array[23 + offset]);
    (s[24] = array[24 + offset]),
      (s[25] = array[25 + offset]),
      (s[26] = array[26 + offset]);
  }
