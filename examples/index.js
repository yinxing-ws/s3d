...
const textures = {
  m1: {
    color:
      'https://gw.alipayobjects.com/zos/OasisHub/440001015/2220/T_BBY_lola_color_01.png',
    normal:
      'https://gw.alipayobjects.com/zos/OasisHub/440001015/1641/T_BBY_lola_normal_01.png',
    orm: 'https://gw.alipayobjects.com/zos/OasisHub/440001015/6473/T_BBY_lola_orm_01.png',
  },
  m2: {
    color:
      'https://gw.alipayobjects.com/zos/OasisHub/440001015/715/T_BBY_lola_color_02.png',
    normal:
      'https://gw.alipayobjects.com/zos/OasisHub/440001015/2651/T_BBY_lola_normal_02.png',
...
const load = (url) =>
  engine.resourceManager.load({ type: AssetType.Texture2D, url });

engine.resourceManager
  .load({ type: AssetType.GLTFResource, url: path })
  .then((gltf) => {
    // 添加gltf模型
